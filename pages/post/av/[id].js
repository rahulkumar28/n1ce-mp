...
export default function BuyAvatar({ postData }) {
    const PriceContent = [
        {
            //href: "",
            image: "images/2.jpg",
...
export async function getStaticPaths() {
    ...
    */
    ...
    const paths = avatars.map((mv, index) => ({
...
export async function getStaticProps({ params }) {
    const postData = avatars[params.id];
    return {
        props: {
            postData
        }
