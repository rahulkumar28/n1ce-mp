...
export default function BuyMetaverse({ postData }) {
    const PriceContent = [
        {
            //href: "",
            image: "images/2.jpg",
...
export async function getStaticPaths() {
    ...
    */
    ...
    const paths = metaverse.map((mv, index) => ({
...
export async function getStaticProps({ params }) {
    const postData = metaverse[params.id];
    return {
        props: {
            postData
        }
